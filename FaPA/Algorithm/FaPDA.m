...
cd 'C:\Users\warri\Dropbox\yo\paper para trabajar\artículo para trabajr\respuestas\FaPDA\Videos' %% Identify the address where the videos to be used are located
video_baseline=VideoReader('Baseline.mp4');% reading the video to be used of baseline
video_transection=VideoReader('Paralysis.mp4');% reading the video to be used of transection day 1
...
%% Use FaPA: Facial paralysis algorithm applied in baseline mice
...
%% Use FaPA: Facial paralysis algorithm applied in paralyzed mice
